...
public class PlaceVO {
	...
	public String toString() {
		return "PlaceVO [place_big=" + place_big + ", place_number=" + place_number + ", place_small=" + place_small
				+ ", place_city=" + place_city + ", place_dong=" + place_dong + ", place_info=" + place_info
				+ ", place_addr=" + place_addr + ", place_middle=" + place_middle + ", place_area=" + place_area
				+ ", place_idx=" + place_idx + ", place_img=" + place_img + ", place_detail=" + place_detail
				+ ", place_mapx=" + place_mapx + ", place_mapy=" + place_mapy + "]";
	}
