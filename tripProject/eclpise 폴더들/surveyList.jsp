			...
			<nav id="nino-navbar" class="navbar navbar-default" role="navigation">
				<div class="container">
					...
					<!-- 화면이 작아지면 헤더 메뉴 토글로 바뀐다. -->
						...
						<!-- 왼쪽 상단 로고부분 -->
						<a class="navbar-brand" href="hitrip.jsp">HITRIP</a>
					</div>
  ...
  <div class="text-end">
    ...
    <section id="nino-map">
    	<div class="container">
    		...
    		<div class="mapWrap">
	    		<iframe src="https://www.google.com/maps/place/서울특별시+마포구+양화진길+46/data=!3m1!4b1!4m5!3m4!1s0x357c98d579614a95:0x4de5512330d9ccd2!8m2!3d37.5464592!4d126.9115418" width="800" height="600" frameborder="0" style="border:0" allowfullscreen></iframe>
	    	</div>
    	</div>
    </section><!--/#nino-map-->
